...
class P10TestSuite extends FunSuite {
  test("encode an ordinary list: encode(List('a, 'a, 'a, 'a, 'b, 'c, 'c, 'a, 'a, 'd, 'e, 'e, 'e, 'e)) = List(List('a, 'a, 'a, 'a), List('b), List('c, 'c), List('a, 'a), List('d), List('e, 'e, 'e, 'e))") {
    assert(P10.encode(List('a, 'a, 'a, 'a, 'b, 'c, 'c, 'a, 'a, 'd, 'e, 'e, 'e, 'e)) === List((4,'a), (1,'b), (2,'c), (2,'a), (1,'d), (4,'e)))
  }
  test("encode an ordinary list: encode(List(1, 1, 2, 1, 3, 5, 8)) = List(1, 2, 1, 3, 5, 8)") {
    assert(P10.encode(List(1, 1, 2, 1, 3, 5, 8)) === List((2, 1), (1, 2), (1, 1), (1, 3), (1, 5), (1, 8)))
  }
  test("encode an one-item list: encode(List(3)) = List(3)") {
